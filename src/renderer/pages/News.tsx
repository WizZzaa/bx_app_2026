  ...
  return (
    <div className="custom-scrollbar flex-1 overflow-y-auto bg-bx-bg px-4 py-4 text-bx-text sm:px-6 sm:py-6">
      <div className="bx-page-container space-y-5">
        ...
        <p className="pb-4 text-center text-xs leading-relaxed text-bx-muted">Перед применением сведений откройте официальный источник и проверьте дату действия нормы.</p>
      </div>
    </div>
  )
}
