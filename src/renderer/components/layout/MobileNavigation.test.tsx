...
describe('MobileNavigation', () => {
  ...
  it('opens extra destinations and closes them with Escape', () => {
    ...
    expect(screen.getByRole('menuitem', { name: /Все функции/ })).toBeTruthy()
    expect(screen.getByRole('menuitem', { name: /Курсы валют/ })).toBeTruthy()
    expect(screen.getByRole('menuitem', { name: /Контроль оплат/ })).toBeTruthy()
