...
Cohesion: 0.16
Nodes (15): COMPANY_ROLE_LABELS, PRIORITY_LABELS, Props, RECURRENCE_LABELS, STATUS_LABELS, TAX_TAGS, today, TYPE_LABELS (+7 more)
...
Cohesion: 0.14
Nodes (16): Props, CalCard, PRI_COLOR, Props, TYPE_ICON, DigestView(), dueChip(), EcpKey (+8 more)
...
Cohesion: 0.07
Nodes (44): uid(), Props, AddCardPayload, BoardKanban(), c(), COLOR_MAP, fmtDate(), isOverdue() (+36 more)
...
Cohesion: 0.27
Nodes (7): buildFocusGroups(), CompanyGroup, dateLabel(), FocusDateGroup, FocusView(), Props, STATUS_LABELS

### Community 51 - "pcClean.ts"
Cohesion: 0.16
Nodes (17): TraderInfo, Condition, describe(), fetchWeather(), WMO, api, BxApi, BxBridge (+9 more)
...
Cohesion: 0.20
Nodes (12): Props, EVENT_TYPE_LABELS, formatPlannerDate(), PlannerEventSummary(), PRIORITY_META, Props, COLUMNS, groupEventsByStatus() (+4 more)
...
Cohesion: 0.25
Nodes (11): CompanyRole, describeEventActivity(), EventActivityTimeline(), STATUS_LABELS, activity, member, valueLabel(), CompanyMember (+3 more)
...
Cohesion: 0.24
Nodes (9): fmtDate(), ListView(), PRI_COLOR, SortKey, STATUS_COLORS, STATUS_LABELS, TYPE_ICON, UnifiedRow (+1 more)
...
- **Why does `todayISO()` connect `todayISO` to `CompanyContext.tsx`, `Templates.tsx`, `useEvents.ts`, `TrayView.tsx`, `CalendarPage.tsx`, `Currency.tsx`, `Finance.tsx`, `ListView.tsx`, `CalendarView.tsx`, `Topbar.tsx`, `CacheCleaner.tsx`, `Dashboard.tsx`, `types.ts`, `EcpManager.tsx`, `SmartCalendar.tsx`, `Planner.tsx`, `BxEvent`, `FocusView.tsx`, `WidgetBoundary`, `ecpParser.ts`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `useToast()` connect `EventActivityTimeline.tsx` to `CompanyContext.tsx`, `useToast`, `Library.tsx`, `NotificationsWidget.tsx`, `Templates.tsx`, `Planner.tsx`, `Translator.tsx`, `CalendarPage.tsx`, `Finance.tsx`, `numToWords.ts`, `TaxCalculator.tsx`, `types.ts`, `syncQueue.ts`?**
